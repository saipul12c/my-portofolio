...
import { Code2, Camera, Rocket, Sparkles, GraduationCap, Users, Award, Heart } from "lucide-react";

const iconMap = { Code2, Camera, Rocket, Sparkles, GraduationCap, Users, Award, Heart };
    ...
    >
      {cards.map((card, i) => {
        ...
        return (
          ...
          >
            {Icon && <Icon className={`w-10 h-10 text-${card.color}-400 mb-4`} />}
            <h2 className={`text-xl font-semibold mb-3 ${textHover} transition`}>{card.title}</h2>
