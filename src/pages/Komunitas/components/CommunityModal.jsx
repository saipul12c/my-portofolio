              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-sm text-gray-300">
                    ...
                    <span>{(selectedCommunity.members || 0).toLocaleString()} anggota</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-300">
                    <MapPin className="h-4 w-4 mr-3 text-cyan-400" />
                    <span>{selectedCommunity.location || 'Lokasi tidak tersedia'}</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-300">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedCommunity.tags?.length > 0 ? (
                      ...
                      <div className="text-gray-400 text-sm">Tidak ada tags</div>
                    )}
                  </div>
                </div>
              </div>
